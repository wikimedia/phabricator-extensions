...
class SetSubtypeHeraldAction extends HeraldAction {
  ...
  public function getHeraldActionName() {
    return pht('Change type to');
  }

  public function renderActionDescription($value) {
    $type = head($value);
    return pht("Change type to \"%s\"", $type);
  }
  ...
  protected function renderActionEffectDescription($type, $data) {
    switch ($type) {
      case self::DO_SUBTYPE:
        return pht('Change type to "%s."', $data);
    }
  }
